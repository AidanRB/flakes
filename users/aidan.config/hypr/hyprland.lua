...
hl.bind("SUPER + XF86AudioPrev", hl.dsp.exec_cmd("playerctl previous"))
hl.bind("SUPER + XF86AudioNext", hl.dsp.exec_cmd("playerctl next"))
hl.bind("SUPER + XF86AudioPause", hl.dsp.exec_cmd("playerctl play-pause"))
hl.bind("SUPER + XF86AudioPlay", hl.dsp.exec_cmd("playerctl play-pause"))
-- these don't work on a desktop, need to replace
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("brightnessctl -e4 -n2 set 5%+"))
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightnessctl -e4 -n2 set 5%-"))

-- binds: launchers
hl.bind("SUPER", hl.dsp.exec_cmd("walker"), {
  release = true,
})
